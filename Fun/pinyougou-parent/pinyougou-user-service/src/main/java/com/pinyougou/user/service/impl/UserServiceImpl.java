...
public class UserServiceImpl implements UserService {
	...
	public void add(TbUser user) {
		...
		String md5HexPassword= DigestUtils.md5Hex(user.getPassword());
	...
	@Override
	public Boolean checkSmdCode(String phone, String code) {
		// 先从redies 中拿出存好的验证码然后进行比较
